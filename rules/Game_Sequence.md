...
Models of the Active Player may declare the use of any applicable Abilities, Items, or Stratagems. A Leader's Stratagems can only be declared during this Phase.

**II) The Upkeep Phase**
All players allocate Activation Points to all of their models equal to their models' Stamina values.
...
An activated model may declare Normal Movement or Special Movement. The Active Player must declare all Skills relevant to its Movement. During this Step, the activated model may enter or cancel the Crouched State (at the start or end of the Movement).

### Reaction Step

Following the rules of Reaction, the Reactive Player must declare which of their models will react against the Activated model, if any, and which Normal Actions the reacting models will perform.
...
Players apply modifiers. All necessary rolls are performed. Confrontation rolls are carried out where necessary. Models that scored Hits must perform Damage Rolls.

Damage, Effects, and abilities that happened during this Activation Sequence are applied simultaneously. If two effects cannot be resolved simultaneously, the Active player chooses the order in which they are resolved.
